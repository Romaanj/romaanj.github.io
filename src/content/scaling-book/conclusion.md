...
떠나기 전에, NVIDIA GPU를 다루는 새 [12장](/scaling-book/gpus/)도 재미있을 것이다!
...
이 분야에는 포괄적인 글이 들어설 여지가 아직 많이 남아 있으니, 이 원고가 그런 글을 더 많이 이끌어내는 계기가 되기를 바란다! 이 분야가 공부하고 연구하기에 결실이 많은 영역이라고도 믿는다. 많은 경우 하드웨어 가속기가 많지 않아도 할 수 있는 일이다.
